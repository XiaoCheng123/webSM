...
exports.get_click = function(req, res) {
  ...
  var sql = "update `student` set " +
    "Sname = '" + student.Sname + "',Ssex = '"
    + student.Ssex + "',Sbirth = '" + student.Sbirth + "',Sid = '" + student.Sid + "',Spolitic = '" + student.Spolitic + "',Scome = '" + student.Scome + "',Sminzu = '"
    + student.Sminzu + "',Sjiguan = '"
    + student.Sjiguan + "',Sdistrist = '" + student.Sdistrist + "',Sphone = '" + student.Sphone + "' where Sno = '" + student.Sno + "'"
